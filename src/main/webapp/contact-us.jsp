...
<title>Anty-Plagiat contact</title>
				...
				<div class="art-sheet">
					...
					<div class="art-sheet-body">
						<div class="art-nav">
							...
							<div class="r"></div>
							<ul class="art-menu">
								<li><a href="./index.jsp" ><span class="l"></span><span class="r"> </span><span class="t">Start</span></a></li>
								<li><a href="./about-us.jsp"><span class="l"> </span><span class="r"> </span><span class="t">O nas</span></a></li>
								<li><a href="./contact-us.jsp" class="active"><span class="l"></span><span class="r"> </span><span class="t">Kontakt</span></a></li>
							</ul>
						</div>
											...
											<div class="art-vmenublockcontent">
												<div class="art-vmenublockcontent-body">
													<ul class="art-vmenu">
														...
														<li><a href="./contact-us.jsp" class="active"><span class="l">
														...
														<h2>
															<span style="font-size: 16px;"><span
																...
																style="font-size: 16px;"><span
																	...
																	<ul>
																		<li> E-mail: antyplagiat@pk.edu.pl
																		</li> Telefon: 004823415163
																		<li>  Adres: ul. Warszawska 8, 30-123 Krakow
																		</li> Osoba kontaktowa: Andrzej Kowalski
																		<li>  NIP : 88-09-099-090
																		</li>		
