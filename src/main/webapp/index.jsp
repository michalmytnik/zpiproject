										...
										<div class="art-block-body">
											<div class="art-blockcontent">
												<div class="art-blockcontent-body">
													...
													<p>Plik zostanie sprawdzony z bazą danych programu
														antyplagiatowego. Po dodaniu pliku proszę nacisnąć
														przycisk "sprawdzam" i oczekiwać na wynik</p>
													<div class="cleared"></div>
												</div>
											</div>
											<div class="cleared"></div>
												...
												<div class="art-blockcontent-body">
													<div>
														<form id="form2" method="post"
															action="http://mich:8080/zpiAntyPlagarismProject-1.0/file/uploadAjax"
															enctype="multipart/form-data">
															<!-- File input -->
															<input class="btn btn-primary" name="file2" id="file2"
																type="file"
																style="float: left; background-image: none; background-color: #9ED04C;" /><br />
														</form>

														<button value="Submit" class="btn btn-primary"
															type="button" onclick="uploadFileToRepo()"
											...
											<div id="mainContent">
												<div class="art-post-inner art-article">
													...
													<div class="art-postcontent">
														<h2>
															<span style="font-size: 16px;"><span
																...
																style="font-size: 16px;"><span
																	style="color: rgb(255, 255, 255);">Anty-Plagiat
																		powstał do wykrywania plagiatów w dokumentach
																		uczelnianych takich jak prace dyplomowe czy też
																		artykuły naukowe oraz do ochrony oryginalności
																		tekstów. Jest tworzony jako niezależny projekt i jego
																		działanie nie może określać w 100% czy ktoś popełnił
																		przestępstwo. Jeśli program da wynik pozytywny osoba
																		sprawdzajaca proszona jest o osobiste sprawdzenie
																		treści dokumentu.</span></span></span>
														</h2>
														<p>
														...
														<p>
															<span style="font-size: 14px;">Program został
																stworzony jako projekt uczelniany w ramach przedmiotu
																"Zarządzanie Projektem Informatycznym", do porównania
																dokumentów wykorzystuje najpopularniejsze algorytmy
																wyszukiwania wzorca w tekście takie jak Odległość
																Levenstheina czy też algorytm Boyera i Moora. </span>
														</p>
														<p>
															<span style="font-size: 14px;"><br /></span>
														</p>
														<p>
															<span style="font-size: 14px;">Twórcy programu
																zastrzegają, że jego dystrybucja nie jest zezwolona bez
																zgody twórców i własciciela czyli Politechniki
																Krakowskiej im. Tadeusza Kościuszki </span>
														</p>
														<p>
															<span style="font-size: 14px;"><br /></span>
														</p>
